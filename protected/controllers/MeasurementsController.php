...
class MeasurementsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Measurements']))
		{
			$model->attributes=$_POST['Measurements'];
                ...
                //        $mark =$model->attributes['markerName_id'];
                //        print_r($model);
                       // print"<hr>";
                        //поиск в марка по имени вернуть id если нет придупредить
                //       $mod2 = MarkNams::model()->findByAttributes(array('markers_name'=>$mark));
                //       if($mod2){
                           
                //             $model->markerName_id = $mod2->id;
                         //  $model->attributes['markerName_id']=$mod2->id;
                //       print_r($model);
                //       }else {
	...
	public function actionUpdate($id)
	{
		...
		{
			$model->attributes=$_POST['Measurements'];
                        //$model->attributes['markerName_id'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id));
		}
